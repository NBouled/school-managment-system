<x-app-layout>
    <x-slot name="header">
        ...
        <div class="flex justify-between align-middle">
            ...
            <div>
                @if(!$isEnrolled)
                <form method="POST" action="{{route('student.courses.enroll', ['course' => $course, 'student' => auth()->user()])}}" id="enrollForm">
                    @csrf
                    <button type="submit"  class="float-right flex-shrink-0 px-4 py-2 text-base font-semibold text-white bg-purple-600 rounded-lg shadow-md hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-purple-200"
                            onclick="event.preventDefault(); if(confirm('Are you sure you want to enroll in this course?')) this.form.submit();">
                        Enroll
                    </button>
                </form>
                @endif
